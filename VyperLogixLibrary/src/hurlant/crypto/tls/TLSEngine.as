...
package hurlant.crypto.tls {
	import hurlant.crypto.cert.X509Certificate;
	import hurlant.crypto.cert.X509CertificateCollection;
	...
	[Event(name="ready", type="hurlant.crypto.tls.TLSEvent")]
	[Event(name="data", type="hurlant.crypto.tls.TLSEvent")]
