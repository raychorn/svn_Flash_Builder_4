package utils.compression.as3zlib
{
	...
	public class Deflate 
	{
		...
		public var dyn_ltree: Array;
		// literal and length tree
		public var dyn_dtree: Array;
		// distance tree
		public var bl_tree: Array;
		// Huffman tree for bit lengths
		public var l_desc: Tree = new Tree();
		// desc for literal tree
		public var d_desc: Tree = new Tree();
		// desc for distance tree
		public var bl_desc: Tree = new Tree();
		// desc for bit length tree
		// number of codes at each bit length for an optimal tree
		public var bl_count: Array = new Array();

		// heap used to build the Huffman trees
		public var heap: Array = new Array();

		public var heap_len: int;
		// number of elements in the heap
		public var heap_max: int;
		// element of largest frequency
		// The sons of heap[n] are heap[2*n] and heap[2*n+1]. heap[0] is not used.
		// The same heap array is used to build all trees.
		// Depth of each subtree used as tie breaker for trees of equal frequency
		public var depth: Array = new Array();

		public var l_buf: int;
		...
		public var last_lit: int;
		// running index in l_buf
		// Buffer for distances. To simplify the code, d_buf and l_buf have
		// the same number of elements. To use different lengths, an extra flag
		// array would be necessary.
		public var d_buf: int;
		// index of pendig_buf
		public var opt_len: int;
		// bit length of current block with optimal trees
		public var static_len: int;
		// bit length of current block with static trees
		public var matches: int;
		// number of string matches in current block
		public var last_eob_len: int;
		// bit length of EOB code for last block
		// Output buffer. bits are inserted starting at the bottom (least
		// significant bits).
		public var bi_buf: Number;

		// Number of valid bits in bi_buf.	All bits above the last valid bit
		// are always zero.
		public var bi_valid: int;
		...
		public static function smaller(tree: Array, n: int, m: int, depth: Array) : Boolean {
		...
		public function scan_tree(tree: Array,
		...
		public function set_data_type() : void {
			var n: int = 0;
		...
		public function copy_block(buf: int,
		// the input data
		len: int,
		// its length
		header: Boolean
		...
		public function flush_block_only(eof: Boolean) : void {
		...
		private function _tr_flush_block(buf:int,stored_len:int,eof:Boolean):void {
		...
		public function fill_window() : void {
			var n: int;
			var m:int;
			var p:int;
			var more: int;
		...
		public function longest_match(cur_match: int) : int {
		...
		public function deflateReset(strm: ZStream) : int {
		...
		public function deflateParams(strm: ZStream, _level: int, _strategy: int) : int {
			var err: int = Z_OK;
		 ...
		 * 
		 */
		public function deflateSetDictionary(strm: ZStream, dictionary:ByteArray, dictLength: int) : int {
