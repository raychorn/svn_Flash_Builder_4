package utils.compression.as3zlib
{
	...
	final public class ZStream {
		...
		static private var MAX_WBITS: int = 15;		// 32K LZ77 window
		static private var DEF_WBITS: int = MAX_WBITS;
		...
		public var next_in: ByteArray;			// next input byte
		public var next_in_index: int;
		public var avail_in: int;		// number of bytes available at next_in
		public var total_in: Number;		// total nb of input bytes read so far
		public var next_out: ByteArray;		// next output byte should be put there
		public var next_out_index: int;
		public var avail_out: int;		// remaining free space at next_out
		public var total_out: Number;		// total nb of bytes output so far
