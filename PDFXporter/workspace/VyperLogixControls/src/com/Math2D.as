...
package com {
	...
	public class Math2D {
		/**
		 * Calculate the point given the begining point with distance and slope.
		 */
//		public static function GetPointAlongLine(x1:Number, y1:Number, dist:Number, slope:Number):Point {
