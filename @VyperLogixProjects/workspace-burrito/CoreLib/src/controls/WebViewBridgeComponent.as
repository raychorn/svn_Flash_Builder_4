package controls  {
	...
	/**
	 * A UIComponent wrapper around the StageWebViewBridge
	 * To use,
	 * 
	 * Loading a URL:
	 ...
	 * */
	public class WebViewBridgeComponent extends UIComponent {
		...
		public function WebViewBridgeComponent() {
		 ...
		 * @private
		 * */
		public function get webView():StageWebViewBridge {
			return _webView;
		}
		 ...
		 * */
		[Bindable]
		public function set webView(value:StageWebViewBridge):void {
			_webView = value;
		}
