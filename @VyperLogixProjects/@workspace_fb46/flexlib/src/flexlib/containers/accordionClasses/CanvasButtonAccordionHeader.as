...
public class CanvasButtonAccordionHeader extends CanvasButton implements IDataRenderer
{
	...
	{
		var selector:CSSStyleDeclaration = IStyleManager2(FlexGlobals.topLevelApplication.styleManager).getStyleDeclaration("CanvasButtonAccordionHeader");
		...
		IStyleManager2(FlexGlobals.topLevelApplication.styleManager).setStyleDeclaration("CanvasButtonAccordionHeader", selector, false);
	...
	override protected function createChildren():void
	{
		...
		var styleDecl:CSSStyleDeclaration = IStyleManager2(FlexGlobals.topLevelApplication.styleManager).getStyleDeclaration(className);
