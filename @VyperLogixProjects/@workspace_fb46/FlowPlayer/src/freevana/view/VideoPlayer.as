package freevana.view
{
    ...
    */
    ...
    public class VideoPlayer
    {
        ...
        public static function create(settings:Settings, movieURL:String, subsURL:String, playerConfig:String=null):IVideoPlayer
        {
            if (settings.getPreferredPlayer() == VIDEO_PLAYER_FLOW) {
                return new FlowVideoPlayer(movieURL, subsURL, playerConfig);
            } else {
