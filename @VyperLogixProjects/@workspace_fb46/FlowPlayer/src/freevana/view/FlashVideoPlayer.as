package freevana.view
{
    ...
    */
    public class FlashVideoPlayer extends EventDispatcher implements IVideoPlayer
    {
		...
		private var __prefix__:String = ''; //'http://downloads.vyperlogix.com';

        public function FlashVideoPlayer(movieURL:String, subtitleURL:String, prefix:String=null):void
        {
			if (prefix) {
        ...
        public function init():void
        {
            ...
            var swfURL:String = this.__prefix__+'/videoplayers/FlashVideoPlayer.swf?video=' + escape(_movieURL) + '&subtitle=' + escape(_subtitleURL) + '&subtitleSize=' + escape(_subtitleSize);
            trace('[main] --> '+swfURL);
