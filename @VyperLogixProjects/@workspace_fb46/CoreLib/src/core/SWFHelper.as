package core {
	...
	public class SWFHelper {
		...
		public static function is_url_web_based(url:String):Boolean {
			return ( (url is String) && (url.length > 0) && (url.indexOf(SWFHelper.default_prefix) == -1) );
		}
		...
		public static function get app_name():String {
			...
			if (String(ar[ar.length-1]).toLowerCase().indexOf('swf') > -1) {
				ar.pop();
			}
			return ar.join('.');
		}
