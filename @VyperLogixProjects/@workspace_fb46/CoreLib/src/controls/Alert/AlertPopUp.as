package controls.Alert {
	...
	public class AlertPopUp extends mx.controls.Alert {
		...
		private static var surpriseIcon:Class;

		private static var spaces:String = "           ";
		
		private static const Alert_OK:uint = Alert.OK;
		private static const Alert_YES:uint = Alert.YES;
		private static const Alert_CANCEL:uint = Alert.CANCEL;
		private static const Alert_NO:uint = Alert.NO;
		...
		public static function surpriseNoOkay(message:String, title:String = "Surprise", parent:*=null, closehandler:Function=null):Alert {
			var popup:Alert = show("\n\n" + formatText(message), spaces + title, 0, null, closehandler, surpriseIcon);
			return popup;
		}
		...
		public static function errorNoOkay(message:String, title:String = "Error", closehandler:Function=null):Alert {
			var popup:Alert = show("\n\n" + formatText(message), spaces + title, 0, null, closehandler, iconError);
			return popup;
		}
		...
		public static function confirm(message:String, title:String = "Confirmation", closehandler:Function=null, okLabel:String=null, cancelLabel:String=null):Alert {
			...
			var popup:Alert = show("\n\n" + formatText(message), spaces + title, 0, null, closehandler, iconConfirm);
			return popup;
		}
