package factories {
	...
	public class HyperspaceDriveTechFactory extends ResourceFactory {

		/*
		Constructor is not used... 
		*/
		public function HyperspaceDriveTechFactory():* {
		}
		
		[Bindable]
		public static var name:String = 'hyperspacedrivetech';
