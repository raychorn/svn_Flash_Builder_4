package factories {
	...
	public class SolarSatelliteFactory extends ResourceFactory {

		/*
		Constructor is not used... 
		*/
		public function SolarSatelliteFactory():* {
		}
		
		[Bindable]
		public static var name:String = 'ssatellite';
		...
		public static function next_level():void {
			...
			app.mySO.data.__solarsatellite_resource_level__ = __current_level__;
			app.mySO.flush();
		}
		...
		public static function get current_level_upgrade_cost():Object {
			try {
				return {'metal':ResourceFactory.resource_value_ceiling(level_costs[current_level]),'crystal':ResourceFactory.resource_value_ceiling(level_costs[current_level]/4)};
			} catch (err:Error) {}
			return null;
		}
