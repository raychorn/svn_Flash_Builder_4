package factories {
	...
	public class FusionFactory extends ResourceFactory {
		...
		*/
		...
		[Bindable]
		public static var name:String = 'fusion';
		...
		public static function get current_level_upgrade_cost():Object {
			try {
				return {'metal':ResourceFactory.resource_value_ceiling(level_costs[current_level]),'crystal':ResourceFactory.resource_value_ceiling(level_costs[current_level]/2),'deuterium':ResourceFactory.resource_value_ceiling(level_costs[current_level]/4)};
			} catch (err:Error) {}
			return null;
		}
