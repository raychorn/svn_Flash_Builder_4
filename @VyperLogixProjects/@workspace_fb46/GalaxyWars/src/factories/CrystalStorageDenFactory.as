package factories {
	...
	public class CrystalStorageDenFactory extends ResourceFactory {

		/*
		Constructor is not used... 
		*/
		public function CrystalStorageDenFactory():* {
		}
		
		[Bindable]
		public static var name:String = 'CrystalStorageDen';
		...
		public static function get current_level():int {
			if (__current_level__ < 0) {
				...
				__current_level__ = app.mySO.data.__crystal_den_storage_level__;
			}
		...
		public static function next_level():void {
			__current_level__++;
			var app:GalaxyWars = FlexGlobals.topLevelApplication as GalaxyWars;
			app.mySO.data.__crystal_den_storage_level__ = __current_level__;
			app.mySO.flush();
		}
		...
		public static function level_production_rate_for(level:int):Object {
			...
			var capacity:Number = (resources[CrystalFactory.name] * 24*7)/4;
		...
		public static function level_upgrade_cost_for(level:int):Object {
			try {
				...
				var metal_value:Number = ResourceFactory.resource_value_ceiling((resources[metal]*2.5)*60.0);
				var crystal_value:Number = ResourceFactory.resource_value_ceiling((resources[crystal]*0.5)*60.0);
				var deuterium_value:Number = ResourceFactory.resource_value_ceiling((resources[deuterium]*0.8)*60.0);
				return {
					metal: metal_value,
