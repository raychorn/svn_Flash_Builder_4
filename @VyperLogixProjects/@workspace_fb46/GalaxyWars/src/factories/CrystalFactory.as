package factories {
	...
	public class CrystalFactory extends ResourceFactory {

		/*
		Constructor is not used... 
		*/
		public function CrystalFactory():* {
		}
		
		[Bindable]
		public static var name:String = 'crystal';
		...
		public static function get icon():Class {
			return Images.deuteriumBuildingImageClass;
		}
		...
		public static function get current_level():int {
			if (__current_level__ < 0) {
				...
				__current_level__ = app.mySO.data.__crystal_resource_level__;
			}
		...
		public static function next_level():void {
			__current_level__++;
			var app:GalaxyWars = FlexGlobals.topLevelApplication as GalaxyWars;
			app.mySO.data.__crystal_resource_level__ = __current_level__;
			app.mySO.flush();
		}
		...
		public static function level_production_rate_for(level:int):Object {
			try {
				...
				return {
							crystal:ResourceFactory.resource_value_ceiling(resources[crystal])
				};
			} catch (err:Error) {}
			return null;
		}
		...
		public static function get current_den_capacity():Number {
			var app:GalaxyWars = FlexGlobals.topLevelApplication as GalaxyWars;
			return app.crystal_resource_volume_den_capacity;
		}
		...
		public static function level_upgrade_cost_for(level:int):Object {
			try {
				...
				var crystal:String = ResourceFactory.crystal;
				var metal_value:Number = ResourceFactory.resource_value_ceiling(resources[metal]*2.5);
				var crystal_value:Number = ResourceFactory.resource_value_ceiling(resources[crystal]/2);
				return {
					metal: metal_value,
