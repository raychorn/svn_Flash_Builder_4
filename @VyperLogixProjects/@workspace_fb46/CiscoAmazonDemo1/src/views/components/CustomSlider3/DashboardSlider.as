package views.components.CustomSlider3 {
    ...
    public class DashboardSlider extends HSlider {
        [SkinPart(required="false")] public var incrementButton:Button;
        [SkinPart(required="false")] public var decrementButton:Button;
        [SkinPart(required="false")] public var thumbGroup:Group;
