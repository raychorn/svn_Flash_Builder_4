package com.HAL.utils {
	public class StringUtils {
		...
		public static function reportCharCodes(value:String, reportFunc:Function=null, translateFunc:Function=null, use_html:Boolean = false):String {
			var i:int;
			var ar:Array = [];
			var ar2:Array = [];
			var ch:String;
			...
			return ar.join(' ') + ((use_html) ? '<br>' : ' | ') + ar2.join('');
		}
	}
}