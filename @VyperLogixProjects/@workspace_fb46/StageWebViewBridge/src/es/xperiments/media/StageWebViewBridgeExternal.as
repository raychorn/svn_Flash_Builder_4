...
package es.xperiments.media
{
	...
	public class StageWebViewBridgeExternal extends EventDispatcher
	{
		...
		public function call(functionName:String, callback:Function = null,  ... arguments):void
		{
			...
			_activeStage.loadURL("javascript:StageWebViewBridge.doCall('"+Base64.encodeString( com.adobe.serialization.json.JSON.encode( _serializeObject ) ) +"')");
		}
		...
		{
			_serializeObject = com.adobe.serialization.json.JSON.decode( Base64.decode( base64String ).toString() );
