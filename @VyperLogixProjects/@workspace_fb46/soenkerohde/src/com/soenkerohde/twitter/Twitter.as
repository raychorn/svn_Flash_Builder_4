package com.soenkerohde.twitter {
	...
	public class Twitter extends EventDispatcher implements ITwitter {
		...
		public static const VERIFY_CREDENTIALS:String = "http://api.twitter.com/1/account/verify_credentials.json";
		public static const REQUEST_TOKEN:String = "http://api.twitter.com/oauth/request_token";
